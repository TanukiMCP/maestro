#!/usr/bin/env python3
"""
Static Tool Definitions for TanukiMCP Maestro
Pure tool schemas with no imports, no side effects, no initialization.
Designed for instant tool discovery by Smithery and other MCP clients.
"""

from mcp.types import Tool

# Static tool definitions - MUST be instantaneous, no side effects
STATIC_TOOLS = [
    Tool(
